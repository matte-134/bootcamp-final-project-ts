...
const AddToTable = () => {
    ...
    const getUnoccupidTables = () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield fetch('http://localhost:8000/unoccupied/find');
    ...
    const handleSubmit = (ev) => {
        ev.preventDefault();
        const postToTable = (tNumber) => __awaiter(void 0, void 0, void 0, function* () {
